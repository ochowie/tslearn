...
/***/ function(module, exports, __webpack_require__) {
	...
	var Counter = function Counter(props) {
	    return React.createElement("div", null, React.createElement("p", null, React.createElement("label", null, props.field, ": "), React.createElement("b", null, "#", props.counter)), React.createElement("button", { onClick: function onClick(e) {
	            return props.incr(props.field);
	        } }, "INCREMENT"), React.createElement("span", { style: { padding: "0 5px" } }), React.createElement("button", { onClick: function onClick(e) {
